...
// MoWay.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMoWayApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMoWayApp
...
// El único objeto CMoWayApp

CMoWayApp theApp;


// Inicialización de CMoWayApp

BOOL CMoWayApp::InitInstance()
{
