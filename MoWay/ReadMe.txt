...
El Asistente para aplicaciones ha creado esta aplicación MoWay.
...
constituyen su aplicación MoWay.
...
MoWayDlg.h, MoWayDlg.cpp – el cuadro de diálogo
    Estos archivos contienen su clase CMoWayDlg.  Esta clase define 
    el comportamiento del cuadro de diálogo principal de su aplicación. La 
    plantilla del cuadro de diálogo está en MoWay.rc, que puede 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado MoWay.pch y un archivo de 
